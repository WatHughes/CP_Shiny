...
shinyUI(fluidPage(
    ...
    (
        ...
        (
            ...
            tags$a(href='http://download.bls.gov/pub/time.series/cs','download.bls.gov/pub/time.series/cs'),
            'and data documentation',
            'is available in the file cs.txt at that location. Even more documentation is at',
            tags$a(href='http://www.bls.gov/iif/oiics_manual_2010.pdf','www.bls.gov/iif/oiics_manual_2010.pdf'),
